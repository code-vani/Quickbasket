...
//is baar previous step ka function pass hai
//taki welcome componet se back button pe click krne pe welcome componenet dikhe
type propType={
...
function RegisterForm({previousStep}:propType) {
    ...
    const handleRegister=async (e:React.FormEvent)=>{
        e.preventDefault()
        setLoading(true)
        //axios ke through post req bhejnge backend ko and data fetch krenge
        //aur idhr we write the api and fetch it
        //ismei hamne data daalkr bhejdiya apna 
        try {
